...
public void testDisplayHomePage()
{
	...
	Object[] testdetails=new Object[]{"TD3_JavaPetApplication","Display HomePage","User should be able to view HomePage",status,(new Date()).getTime(),"1","HomePage Module","Production","1.3",Duration,"Google Chrome","Windows 10","SriHarsha Gadepalli",buildnumber};
