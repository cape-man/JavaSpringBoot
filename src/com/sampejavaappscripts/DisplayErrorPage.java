...
public void testDisplayErrorPage()
{
	...
	Object[] testdetails=new Object[]{"TD4_JavaPetApplication","Display ErrorPage","User should be able to view ErrorPage",status,(new Date()).getTime(),"1","ErrorPage Module","Production","1.3",Duration,"Google Chrome","Windows 10","SriHarsha Gadepalli",buildnumber};
